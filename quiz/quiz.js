const archetypes = {
  ritualista: {
    ...
    giftUrl: "/quiz/Recursos gratuitos para cada arquetipo/1-tu-altar-ciclico.pdf"
  },
  ejecutiva: {
    index: "02 / 07",
    ...
    giftUrl: "/quiz/Recursos gratuitos para cada arquetipo/2-sostener-tu-vision.pdf"
  },
  desconectada: {
    index: "03 / 07",
    ...
    giftUrl: "/quiz/Recursos gratuitos para cada arquetipo/3-diccionario-menstrual.pdf"
  },
  sensible: {
    index: "04 / 07",
    ...
    giftUrl: "/quiz/Recursos gratuitos para cada arquetipo/4-no-estoy-rota.pdf"
  },
  sabia: {
    index: "05 / 07",
    ...
    giftUrl: "/quiz/Recursos gratuitos para cada arquetipo/5-ritual-luna-menguante.pdf"
  },
  rebelde: {
    index: "06 / 07",
    ...
    giftUrl: "/quiz/Recursos gratuitos para cada arquetipo/6-mi-cuerpo-es-revolucion.pdf"
  },
  alquimista: {
    index: "07 / 07",
    ...
    giftUrl: "/quiz/Recursos gratuitos para cada arquetipo/7-trackear-tu-ciclo.pdf"
  }
};
